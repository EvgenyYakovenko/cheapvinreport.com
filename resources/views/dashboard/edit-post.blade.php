<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form method="POST" action="{{ route('dashboard.posts.update', $post->id) }}" id="postForm">
                @csrf
                @method('PUT')
                                ...
                                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                                    <div class="p-6">
                                        ...
                                        <input
                                            ...
                                            value="{{ old("title_{$localeKey}", $localeKey === $defaultLocale ? ($post->translations[$localeKey]['title'] ?? $post->title) : ($post->translations[$localeKey]['title'] ?? '')) }}"
                                ...
                                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                                    <div class="p-6">
                                        ...
                                        <textarea
                                            ...
                                            data-locale="{{ $localeKey }}"
                                        >{{ old("content_{$localeKey}", $localeKey === $defaultLocale ? ($post->translations[$localeKey]['content'] ?? $post->content) : ($post->translations[$localeKey]['content'] ?? '')) }}</textarea>
                                ...
                                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                                    ...
                                    <div class="p-6">
                                        ...
                                        <input
                                            ...
                                            value="{{ old("thumbnail_{$localeKey}", $localeKey === $defaultLocale ? ($post->translations[$localeKey]['thumbnail'] ?? $post->thumbnail) : ($post->translations[$localeKey]['thumbnail'] ?? '')) }}"
                                    ...
                                    <div class="p-6 space-y-4">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                value="{{ old("meta_title_{$localeKey}", $localeKey === $defaultLocale ? ($post->translations[$localeKey]['meta_title'] ?? $post->meta_title) : ($post->translations[$localeKey]['meta_title'] ?? '')) }}"
                                                maxlength="255"
                                        ...
                                        <div>
                                            ...
                                            <textarea
                                                ...
                                                data-locale="{{ $localeKey }}"
                                            >{{ old("meta_description_{$localeKey}", $localeKey === $defaultLocale ? ($post->translations[$localeKey]['meta_description'] ?? $post->meta_description) : ($post->translations[$localeKey]['meta_description'] ?? '')) }}</textarea>
                                        </div>
                                        <div>
                                            ...
                                            <input
                                                ...
                                                value="{{ old("meta_keywords_{$localeKey}", $localeKey === $defaultLocale ? ($post->translations[$localeKey]['meta_keywords'] ?? $post->meta_keywords) : ($post->translations[$localeKey]['meta_keywords'] ?? '')) }}"
    ...
    <script>
        ...
        // Slug auto-generation is disabled for editing (only used when creating new posts)
