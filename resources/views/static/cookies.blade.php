{{-- STAGING: legal page (cookies). Meta from StaticPageController. i18n lang/legal.cookies. --}}
@include('header')
@php $homeUrl=\App\Support\LocaleRoute::route('index'); $g='legal.cookies'; @endphp
